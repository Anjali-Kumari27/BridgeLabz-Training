...
## Week 2: Java Object-Oriented Programming (OOP) and Working on Eclipse

### Day 10: Eclipse environment setup and Introduction to OOPs
**Date:** 26-Dec-2025

1. Installed and configured Eclipse.
2. Set up and reviewed the `java-oops-practice` branch structure.
...
│── README.md
```
3. Introduced Object-Oriented Programming (OOP).
4. Understood the difference between Procedural Programming and OOP.
5. Learned why OOP is used in modern applications.
...
🔗 *Code Link*
[Day 21: Scenario-based](https://github.com/Anjali-Kumari27/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based)
